...
public class DateUtils {
     ...
     * @return
     */
    public static Date getStartTimeByWeek() {
     ...
     * @return
     */
    public static Date getEndTimeByWeek() {
     ...
     * @return
     */
    public static Date getStartTimeByDay() {
...
//        calStart.set(Calendar.SECOND, 0);
     ...
     * @return
     */
    public static Date getEndTimeByDay() {
...
//		long date = System.currentTimeMillis();
    ...
    public static void main(String[] args) {
        ...
        System.err.println(sdf.format(getStartTimeByWeek()));
        System.err.println(getStartTimeByWeek());
        System.err.println(sdf.format(getEndTimeByWeek()));
    }
}
